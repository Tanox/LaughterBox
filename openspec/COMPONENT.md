...
| 组件名 | 文件名 | 版本 | 类型 | 状态 |
|-------|-------|------|------|------|
| Page | app/page.tsx | v6.2.0 | 页面组件 | ✅ 核心 |
| FavoritesPage | app/favorites/page.tsx | v6.2.0 | 页面组件 | ✅ 核心 |
| ThemeProvider | app/components/theme-provider.tsx | v6.2.0 | 上下文提供者 | ✅ 核心 |
| ThemeToggle | app/components/theme-toggle.tsx | v6.2.0 | UI 组件 | ✅ 核心 |
| JokeCard | app/components/joke-card.tsx | v6.2.0 | UI 组件（shadcn Card） | ✅ 核心 |
| NavigationControls | app/components/navigation-controls.tsx | v6.2.0 | UI 组件（shadcn Button） | ✅ 核心 |
| PageDecorations | app/components/page-decorations.tsx | v6.2.0 | UI 组件（Logo、骨架屏） | ✅ 核心 |
| Button | components/ui/button.tsx | v6.2.0 | shadcn 基础组件 | ✅ 基础 |
| Card | components/ui/card.tsx | v6.2.0 | shadcn 基础组件 | ✅ 基础 |
| Toast | components/ui/toast.tsx | v6.2.0 | shadcn 反馈组件 | ✅ 基础 |
| useFavorites | app/hooks/use-favorites.ts | v6.2.0 | 自定义 Hook | ✅ 核心 |
| useClipboard | app/hooks/use-clipboard.ts | v6.2.0 | 自定义 Hook | ✅ 核心 |
| clipboard | app/lib/clipboard.ts | v6.2.0 | 工具函数 | ✅ 基础 |
